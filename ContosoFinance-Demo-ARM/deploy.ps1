...
$resourceGroupName = "AiswaryaCIaCS-rg"  #provide resource group name
...
$templateFileURI = 'https://raw.githubusercontent.com/Aiswaryasharma/CIaCSTrainingARM/main/ContosoFinance-Demo-ARM/ARM-Templates/template.json'
$parametersFileURI = 'https://raw.githubusercontent.com/Aiswaryasharma/CIaCSTrainingARM/main/ContosoFinance-Demo-ARM/ARM-Templates/paramters.json'
